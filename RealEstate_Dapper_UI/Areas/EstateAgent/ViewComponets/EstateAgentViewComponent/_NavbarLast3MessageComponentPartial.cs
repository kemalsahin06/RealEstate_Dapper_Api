...
namespace RealEstate_Dapper_UI.Areas.EstateAgent.ViewComponets.EstateAgentViewComponent
{
    public class _NavbarLast3MessageComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44346/api/Messages?id=" + id);
