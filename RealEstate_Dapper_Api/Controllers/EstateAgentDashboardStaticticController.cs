...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    [ApiController]
    public class EstateAgentDashboardStaticticController : ControllerBase
    {
        private readonly IStatisticRepository _statisticRepository;
        public EstateAgentDashboardStaticticController(IStatisticRepository statisticRepository)
        {
